...
//     sprintf(buf, "c:%d,p:%d,i:%d", currentMillis, previousMillis, interval);
  //      lcd.print(buf);
//  lcd.print(interval);
//  lcd.print(":");
//  lcd.print(previousMillis);
 ...
 // lcd.print(interval);
//  lcd.print(":");
//     sprintf(buf, "%d:%d:%d", (currentMillis)/1000/60/60, (currentMillis)/1000/60, (currentMillis)/1000);
//        lcd.print(buf);
        
  lcd.print((currentMillis)/1000/60/60);  
    lcd.print(":");
  lcd.print((currentMillis)/1000/60);  
    lcd.print(":");
    lcd.print((currentMillis)/1000);
//lcd.print(interval / 1000 );
//    lcd.print(interval-currentMillis - previousMillis);  
    delay(1000);    
 // }
}
